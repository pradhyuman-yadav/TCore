...
from app.routers import backtest, control, events, hawkes, health, impact, live, market, news, paper, signals, social, sources, strategy, watchlist, ws
...
app.include_router(hawkes.router)
